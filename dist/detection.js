 ...
 */
function detectExtendedUnderlineSupport() {
 ...
 */
let _supportsExtendedUnderline = null;
/**
 * Check if the terminal supports extended underline styles.
 * Result is cached after first call.
 */
export function supportsExtendedUnderline() {
 ...
 */
export function setExtendedUnderlineSupport(supported) {
